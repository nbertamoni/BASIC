...
N 880 -150 880 -120 {lab=GND}
N 880 -250 880 -210 {lab=AVDD}
...
C {vsource.sym} 880 -180 0 0 {name=V1 value=1.2 savecurrent=false}
C {gnd.sym} 300 100 0 0 {name=l1 lab=GND}
C {gnd.sym} 880 -120 0 0 {name=l2 lab=GND}
C {lab_wire.sym} 880 -240 0 0 {name=p1 sig_type=std_logic lab=AVDD}
...
C {code_shown.sym} 940 -670 0 0 {name=s1 only_toplevel=false value="
.temp 27
.control
 save all
 ...
 *tran 1n 10u 0 100p
 *write tb_current_mirror_TRAN.raw 
 *dc V1 0 1.2 0.01
 dc V1 1.2 1.2 0.01
 set filetype=ascii
