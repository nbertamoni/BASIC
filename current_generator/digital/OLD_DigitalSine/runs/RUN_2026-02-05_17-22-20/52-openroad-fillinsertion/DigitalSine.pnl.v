module DigitalSine (clk,
 ...
 sg13g2_xor2_1 _200_ (.B(_031_),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_and2_1 _201_ (.A(net65),
    .B(net51),
    .X(_032_),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_xor2_1 _202_ (.B(net51),
    .A(net65),
    .X(_033_),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_nand3_1 _244_ (.B(_107_),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_nor2_1 _245_ (.A(net62),
    .B(net50),
    .Y(_070_),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_nor3_1 _246_ (.A(net62),
    .B(net50),
    .C(net71),
    .Y(_071_),
    .VDD(VPWR),
 ...
 sg13g2_dfrbpq_1 _301_ (.RESET_B(_008_),
    ...
    .Q(\CTRL.S0 ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_buf_8 fanout50 (.A(_098_),
    .X(net50),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout51 (.A(\CTRL.S0 ),
    .X(net51),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout52 (.A(\CTRL.S0 ),
    .X(net52),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout53 (.A(net56),
    .X(net53),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_buf_2 fanout55 (.A(net56),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_1 fanout56 (.A(\DPATH.SUM.fa_6.A ),
    .X(net56),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout57 (.A(net61),
    .X(net57),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_buf_8 fanout69 (.A(net70),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout70 (.A(\DPATH.SUM.fa_2.A ),
    .X(net70),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_buf_2 fanout72 (.A(net73),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_1 fanout73 (.A(\DPATH.SUM.fa_1.A ),
    .X(net73),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout74 (.A(net39),
    .X(net74),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout75 (.A(\DPATH.SUM.Cout0 ),
    .X(net75),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_decap_8 FILLER_1_101 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_decap_4 FILLER_1_108 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_decap_8 FILLER_3_14 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_2 FILLER_3_21 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_1 FILLER_3_82 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_fill_2 FILLER_6_62 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_2 FILLER_6_69 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_fill_1 FILLER_7_118 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_2 FILLER_8_5 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_fill_2 FILLER_8_83 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_2 FILLER_8_93 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_fill_1 FILLER_10_58 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_2 FILLER_10_93 (.VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_fill_2 FILLER_11_96 (.VDD(VPWR),
    .VSS(VGND));
 sg13g2_fill_1 FILLER_11_98 (.VDD(VPWR),
    .VSS(VGND));
