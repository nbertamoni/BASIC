module DigitalSine (clk,
 ...
 sg13g2_buf_8 fanout52 (.A(\CTRL.S0 ),
    .X(net52));
 sg13g2_buf_1 fanout53 (.A(\CTRL.S0 ),
    .X(net53));
 ...
 sg13g2_buf_8 fanout58 (.A(\DPATH.SUM.fa_5.A ),
    .X(net58));
 sg13g2_buf_2 fanout59 (.A(\DPATH.SUM.fa_5.A ),
    .X(net59));
