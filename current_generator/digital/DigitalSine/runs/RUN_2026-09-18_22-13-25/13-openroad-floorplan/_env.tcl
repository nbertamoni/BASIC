set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/config.tracks
...
set ::env(VDD_PIN) DVDD
set ::env(GND_PIN) DVSS
...
set ::env(CELL_LIBS) "\"*_typ_1p20V_25C\" \"/foss/pdks/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_typ_1p20V_25C.lib.gz /foss/pdks/ihp-sg13g2/libs.ref/sg13g2_io/lib/sg13g2_io_typ_1p2V_3p3V_25C.lib.gz\" \"*_fast_1p32V_m40C\" \"/foss/pdks/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_fast_1p32V_m40C.lib.gz /foss/pdks/ihp-sg13g2/libs.ref/sg13g2_io/lib/sg13g2_io_fast_1p32V_3p6V_m40C.lib.gz\" \"*_slow_1p08V_125C\" \"/foss/pdks/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_slow_1p08V_125C.lib.gz /foss/pdks/ihp-sg13g2/libs.ref/sg13g2_io/lib/sg13g2_io_slow_1p08V_3p0V_125C.lib.gz\""
...
set ::env(PAD_SPICE_MODELS) /foss/pdks/ihp-sg13g2/libs.ref/sg13g2_io/spice/sg13g2_io.spice
...
set ::env(PNR_SDC_FILE) /foss/designs/BASIC/current_generator/digital/DigitalSine/cons.sdc
set ::env(DEDUPLICATE_CORNERS) 0
set ::env(FP_TRACKS_INFO) /foss/pdks/ihp-sg13g2/libs.tech/librelane/sg13g2_stdcell/tracks.info
set ::env(FP_SIZING) relative
set ::env(FP_ASPECT_RATIO) 1.0
set ::env(FP_CORE_UTIL) 61.0
set ::env(BOTTOM_MARGIN_MULT) 4.0
set ::env(TOP_MARGIN_MULT) 4.0
set ::env(LEFT_MARGIN_MULT) 12.0
set ::env(RIGHT_MARGIN_MULT) 12.0
set ::env(CURRENT_NL) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/06-yosys-synthesis/DigitalSine.nl.v
set ::env(SAVE_ODB) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/DigitalSine.odb
set ::env(SAVE_DEF) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/DigitalSine.def
set ::env(SAVE_SDC) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/DigitalSine.sdc
set ::env(SAVE_NL) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/DigitalSine.nl.v
set ::env(SAVE_PNL) /foss/designs/BASIC/current_generator/digital/DigitalSine/runs/RUN_2026-09-18_22-13-25/13-openroad-floorplan/DigitalSine.pnl.v
