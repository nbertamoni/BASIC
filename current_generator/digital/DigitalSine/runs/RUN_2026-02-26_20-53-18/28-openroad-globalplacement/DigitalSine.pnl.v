module DigitalSine (clk,
 ...
 sg13g2_nor3_2 _255_ (.A(net53),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_a21oi_2 _256_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net46),
    .Y(sine_out[6]),
    .A2(_106_),
    .A1(net53));
 sg13g2_a21oi_2 _257_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net46),
    .Y(sine_out[7]),
    .A2(_065_),
    .A1(net54));
 sg13g2_a21oi_2 _258_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net46),
    .Y(sine_out[8]),
    .A2(_078_),
    .A1(net53));
 sg13g2_a21oi_2 _259_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net49),
    .Y(sine_out[9]),
    .A2(_077_),
 ...
 sg13g2_nand2b_2 _264_ (.Y(_081_),
    ...
    .VSS(VGND),
    .A_N(net59));
 sg13g2_a21oi_2 _265_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net49),
    .Y(sine_out[12]),
    .A2(_081_),
    .A1(_109_));
 sg13g2_a21oi_2 _266_ (.VSS(VGND),
    .VDD(VPWR),
    .B1(net49),
    .Y(sine_out[13]),
    .A2(_114_),
