module DigitalSine (clk,
 ...
 sg13g2_inv_1 _128_ (.Y(_083_),
    .A(\DPATH.SUM.fa_6.A ));
 sg13g2_inv_1 _129_ (.Y(signB),
    .A(sign));
 sg13g2_inv_1 _130_ (.Y(_084_),
    .A(\DPATH.SUM.fa_3.A ));
 sg13g2_inv_1 _131_ (.Y(_085_),
    .A(\DPATH.SUM.fa_2.A ));
 sg13g2_inv_1 _132_ (.Y(_086_),
    .A(\DPATH.SUM.fa_1.A ));
 sg13g2_inv_1 _133_ (.Y(\DPATH.SUM.ha_0.S ),
    .A(\DPATH.SUM.Cout0 ));
 ...
 sg13g2_nor3_1 _166_ (.A(\DPATH.SUM.Cout0 ),
    ...
    .C(_113_),
    .Y(_115_));
 sg13g2_a21oi_1 _167_ (.A1(\DPATH.SUM.fa_6.A ),
    .A2(_115_),
    .Y(_116_),
    .B1(\CTRL.S0 ));
 ...
 sg13g2_nand2_1 _175_ (.Y(_123_),
    .A(_084_),
    .B(_122_));
 sg13g2_a21oi_1 _176_ (.A1(\DPATH.SUM.fa_3.A ),
    .A2(\DPATH.SUM.fa_1.A ),
    .Y(_124_),
    .B1(\DPATH.SUM.fa_4.A ));
 ...
 sg13g2_o21ai_1 _191_ (.B1(_019_),
    ...
    .A1(\DPATH.SUM.Cout0 ),
    .A2(_119_));
 sg13g2_a21oi_1 _192_ (.A1(\DPATH.SUM.Cout0 ),
    .A2(_118_),
    .Y(_021_),
    .B1(_020_));
 ...
 sg13g2_and3_1 _206_ (.X(_035_),
    ...
    .B(\DPATH.SUM.fa_1.A ),
    .C(\DPATH.SUM.Cout0 ));
 sg13g2_a21oi_1 _207_ (.A1(\DPATH.SUM.fa_4.A ),
    .A2(_106_),
    .Y(_036_),
    .B1(_035_));
 sg13g2_a21oi_1 _208_ (.A1(\DPATH.SUM.fa_3.A ),
    .A2(_034_),
    .Y(_037_),
    .B1(_036_));
 ...
 sg13g2_nor3_1 _255_ (.A(\DPATH.SUM.fa_4.A ),
    ...
    .C(_078_),
    .Y(sine_out[5]));
 sg13g2_a21oi_1 _256_ (.A1(\DPATH.SUM.fa_4.A ),
    .A2(_106_),
    .Y(sine_out[6]),
    .B1(_103_));
 sg13g2_a21oi_1 _257_ (.A1(\DPATH.SUM.fa_4.A ),
    .A2(_065_),
    .Y(sine_out[7]),
    .B1(_103_));
 sg13g2_a21oi_1 _258_ (.A1(\DPATH.SUM.fa_4.A ),
    .A2(_078_),
    .Y(sine_out[8]),
    .B1(_103_));
 sg13g2_a21oi_1 _259_ (.A1(\DPATH.SUM.fa_5.A ),
    .A2(_077_),
    .Y(sine_out[9]),
    .B1(\DPATH.SUM.fa_6.A ));
