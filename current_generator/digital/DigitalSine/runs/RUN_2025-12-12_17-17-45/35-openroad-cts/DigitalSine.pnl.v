module DigitalSine (clk,
 ...
 sg13g2_buf_8 fanout56 (.A(_098_),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout57 (.A(\CTRL.S0 ),
    .X(net57),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout58 (.A(\CTRL.S0 ),
    .X(net58),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_buf_8 fanout61 (.A(net62),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout62 (.A(\DPATH.SUM.fa_6.A ),
    .X(net62),
    .VDD(VPWR),
    .VSS(VGND));
 ...
 sg13g2_buf_8 fanout74 (.A(\DPATH.SUM.fa_2.A ),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout75 (.A(\DPATH.SUM.fa_2.A ),
    .X(net75),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout76 (.A(net77),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout77 (.A(\DPATH.SUM.fa_1.A ),
    .X(net77),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout78 (.A(net79),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_8 fanout79 (.A(\DPATH.SUM.Cout0 ),
    .X(net79),
    .VDD(VPWR),
    .VSS(VGND));
