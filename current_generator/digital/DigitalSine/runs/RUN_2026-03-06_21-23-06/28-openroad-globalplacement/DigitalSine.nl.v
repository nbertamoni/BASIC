module DigitalSine (clk,
 ...
 sg13g2_and3_1 _206_ (.X(_035_),
    ...
    .B(net69),
    .C(net72));
 sg13g2_a21oi_1 _207_ (.A1(net60),
    .A2(_106_),
    .Y(_036_),
    .B1(_035_));
 sg13g2_a21oi_1 _208_ (.A1(net62),
    .A2(_034_),
    .Y(_037_),
    .B1(_036_));
 sg13g2_and2_2 _209_ (.A(net56),
    .B(net54),
    .X(_038_));
 ...
 sg13g2_nand2_2 _251_ (.Y(_077_),
    .A(_022_),
    .B(_039_));
 sg13g2_nor2_2 _252_ (.A(net51),
    .B(_077_),
    .Y(sine_out[3]));
 sg13g2_nor3_2 _253_ (.A(net59),
    .B(net51),
    .C(_065_),
    .Y(sine_out[4]));
 sg13g2_and3_1 _254_ (.X(_078_),
    ...
    .B(net71),
    .C(_111_));
 sg13g2_nor3_2 _255_ (.A(net59),
    .B(_103_),
    .C(_078_),
    .Y(sine_out[5]));
 sg13g2_a21oi_1 _256_ (.A1(net59),
    .A2(_106_),
    .Y(sine_out[6]),
    .B1(net51));
 sg13g2_a21oi_1 _257_ (.A1(net59),
    .A2(_065_),
    .Y(sine_out[7]),
    .B1(net51));
 sg13g2_a21oi_1 _258_ (.A1(net59),
    .A2(_078_),
    .Y(sine_out[8]),
    .B1(net51));
 sg13g2_a21oi_2 _259_ (.B1(net54),
    .Y(sine_out[9]),
    .A2(_077_),
    .A1(net56));
 ...
 sg13g2_buf_4 fanout56 (.X(net56),
    .A(\DPATH.SUM.fa_5.A ));
 sg13g2_buf_2 fanout57 (.A(\DPATH.SUM.fa_5.A ),
    .X(net57));
 ...
 sg13g2_buf_4 fanout64 (.X(net64),
    .A(net65));
 sg13g2_buf_1 fanout65 (.A(\DPATH.SUM.fa_3.A ),
    .X(net65));
