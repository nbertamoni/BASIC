module DigitalSine (clk,
 ...
 sg13g2_buf_1 fanout68 (.A(net69),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_1 fanout69 (.A(\DPATH.SUM.fa_4.A ),
    .X(net69),
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_4 fanout70 (.X(net70),
    ...
    .VDD(VPWR),
    .VSS(VGND));
 sg13g2_buf_2 fanout71 (.A(\DPATH.SUM.fa_3.A ),
    .X(net71),
    .VDD(VPWR),
    .VSS(VGND));
