...
# Environment
###############################################################################
set_load -pin_load 0.0300 [get_ports {sign}]
set_load -pin_load 0.0300 [get_ports {signB}]
set_load -pin_load 0.0100 [get_ports {sine_out[17]}]
set_load -pin_load 0.0100 [get_ports {sine_out[16]}]
set_load -pin_load 0.0100 [get_ports {sine_out[15]}]
set_load -pin_load 0.0100 [get_ports {sine_out[14]}]
set_load -pin_load 0.0100 [get_ports {sine_out[13]}]
set_load -pin_load 0.0100 [get_ports {sine_out[12]}]
set_load -pin_load 0.0100 [get_ports {sine_out[11]}]
set_load -pin_load 0.0100 [get_ports {sine_out[10]}]
set_load -pin_load 0.0100 [get_ports {sine_out[9]}]
set_load -pin_load 0.0100 [get_ports {sine_out[8]}]
set_load -pin_load 0.0100 [get_ports {sine_out[7]}]
set_load -pin_load 0.0100 [get_ports {sine_out[6]}]
set_load -pin_load 0.0100 [get_ports {sine_out[5]}]
set_load -pin_load 0.0100 [get_ports {sine_out[4]}]
set_load -pin_load 0.0100 [get_ports {sine_out[3]}]
set_load -pin_load 0.0100 [get_ports {sine_out[2]}]
set_load -pin_load 0.0100 [get_ports {sine_out[1]}]
set_load -pin_load 0.0100 [get_ports {sine_out[0]}]
###############################################################################
# Design Rules
###############################################################################
