module DigitalSine (clk,
 ...
 sg13g2_buf_4 fanout56 (.X(net56),
    .A(\CTRL.S0 ));
 sg13g2_buf_2 fanout57 (.A(\CTRL.S0 ),
    .X(net57));
 ...
 sg13g2_buf_4 fanout62 (.X(net62),
    .A(net63));
 sg13g2_buf_1 fanout63 (.A(\DPATH.SUM.fa_5.A ),
    .X(net63));
 ...
 sg13g2_buf_1 fanout69 (.A(net70),
    .X(net69));
 sg13g2_buf_2 fanout70 (.A(\DPATH.SUM.fa_4.A ),
    .X(net70));
