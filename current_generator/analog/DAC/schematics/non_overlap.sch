...
N 290 -730 340 -730 {lab=i_sign}
N 290 -700 340 -700 {lab=i_signb}
N 290 -670 340 -670 {lab=sign}
N 290 -640 340 -640 {lab=signb}
...
N 450 -470 600 -470 {lab=a}
C {iopin.sym} 300 -790 0 1 {name=p85 lab=AVDD}
C {iopin.sym} 300 -760 0 1 {name=p86 lab=AVSS}
C {lab_wire.sym} 500 -470 0 0 {name=p92 sig_type=std_logic lab=a}
...
C {iopin.sym} 300 -730 0 1 {name=p6 lab=i_sign}
C {iopin.sym} 300 -700 0 1 {name=p7 lab=i_signb}
C {iopin.sym} 300 -670 0 1 {name=p10 lab=sign}
C {iopin.sym} 300 -640 0 1 {name=p11 lab=signb}
...
C {lab_wire.sym} 520 -250 0 0 {name=p21 sig_type=std_logic lab=b}
