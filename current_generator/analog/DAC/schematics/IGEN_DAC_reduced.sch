...
N -50 720 -50 760 {lab=AVSS}
N 400 360 400 400 {lab=AVDD}
N 400 460 400 500 {lab=AVSS}
N 490 460 490 480 {lab=GND}
N 490 290 490 330 {lab=AVSS}
N 630 360 630 400 {lab=en}
N 630 460 630 500 {lab=AVSS}
N 1230 270 1270 270 {lab=en}
N 1350 270 1420 270 {lab=en_b}
N 1500 270 1540 270 {lab=en_bb}
N 80 -910 170 -910 {lab=VBIAS}
N 80 -910 80 -770 {lab=VBIAS}
N 80 -770 250 -770 {lab=VBIAS}
N 250 -810 250 -770 {lab=VBIAS}
N 740 360 740 400 {lab=SEL}
N 740 460 740 500 {lab=AVSS}
N 850 360 850 400 {lab=in}
N 850 460 850 500 {lab=AVSS}
N 1310 390 1350 390 {lab=in}
N 1430 390 1500 390 {lab=inb}
N 30 440 60 440 {lab=#net1}
N -50 470 -50 530 {lab=#net2}
N 30 560 60 560 {lab=#net3}
N 100 490 100 530 {lab=#net1}
N 30 560 30 610 {lab=#net3}
N -10 560 30 560 {lab=#net3}
N -50 610 30 610 {lab=#net3}
N -50 590 -50 610 {lab=#net3}
N 30 440 30 490 {lab=#net1}
N -10 440 30 440 {lab=#net1}
N 30 490 100 490 {lab=#net1}
N 100 470 100 490 {lab=#net1}
N -50 360 -50 410 {lab=AVDD}
N -50 360 100 360 {lab=AVDD}
N 100 360 100 410 {lab=AVDD}
N 100 590 100 640 {lab=IBIAS}
N -100 440 -50 440 {lab=AVDD}
N -100 560 -50 560 {lab=AVDD}
N 100 560 150 560 {lab=AVDD}
N 100 440 150 440 {lab=AVDD}
N -50 610 -50 660 {lab=#net3}
...
N -510 -50 -450 -50 {lab=sign}
N -510 -30 -450 -30 {lab=sign_b}
N -660 60 -660 90 {lab=AVSS}
N -660 -180 -660 -140 {lab=AVDD}
N -860 -70 -810 -70 {lab=in}
N -860 -50 -810 -50 {lab=inb}
N -860 -30 -810 -30 {lab=a}
N -860 -10 -810 -10 {lab=b}
N 960 360 960 400 {lab=a}
N 960 460 960 500 {lab=AVSS}
N 1050 360 1050 400 {lab=b}
N 1050 460 1050 500 {lab=AVSS}
...
N 490 390 490 400 {lab=#net6}
N 250 -770 250 -750 {lab=VBIAS}
N 250 -690 250 -580 {lab=#net7}
N -110 -50 -50 -50 {lab=sign}
N -110 -30 -50 -30 {lab=sign_b}
N 250 -60 290 -60 {lab=vop}
N 250 -40 290 -40 {lab=vom}
N 100 30 100 60 {lab=AVSS}
N -90 -70 -50 -70 {lab=#net8}
N 1450 -460 1450 -420 {lab=vop}
N 1450 -200 1450 -160 {lab=vom}
N 1450 -290 1450 -260 {lab=#net9}
N 1450 -360 1450 -350 {lab=#net10}
N -310 -90 -250 -90 {lab=ISUM}
N -190 -90 -90 -90 {lab=#net8}
N -90 -90 -90 -70 {lab=#net8}
...
C {isource.sym} -50 690 0 0 {name=I0 value=200n}
C {vsource.sym} 400 430 0 0 {name=V1 value=1.6 savecurrent=false}
C {lab_wire.sym} 400 490 0 0 {name=p40 sig_type=std_logic lab=AVSS}
C {gnd.sym} 490 480 0 0 {name=l1 lab=GND}
C {vsource.sym} 490 430 0 0 {name=V2 value=0 savecurrent=false}
C {lab_wire.sym} 490 310 0 0 {name=p41 sig_type=std_logic lab=AVSS}
C {vsource.sym} 740 430 0 0 {name=V3 value=0 savecurrent=false}
C {lab_wire.sym} 630 370 0 0 {name=p42 sig_type=std_logic lab=en}
C {lab_wire.sym} 630 490 0 0 {name=p43 sig_type=std_logic lab=AVSS}
C {sg13g2_stdcells/sg13g2_inv_1.sym} 1310 270 0 0 {name=x1 VDD=AVDD VSS=AVSS prefix=sg13g2_ }
C {lab_wire.sym} 1240 270 0 0 {name=p44 sig_type=std_logic lab=en}
C {sg13g2_stdcells/sg13g2_inv_1.sym} 1460 270 0 0 {name=x2 VDD=AVDD VSS=AVSS prefix=sg13g2_ }
C {lab_wire.sym} 1400 270 0 0 {name=p45 sig_type=std_logic lab=en_b}
C {lab_wire.sym} -90 -720 0 0 {name=p3 sig_type=std_logic lab=IBIAS}
C {lab_wire.sym} 740 490 0 0 {name=p48 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 740 380 0 0 {name=p5 sig_type=std_logic lab=SEL}
...
"}
C {lab_wire.sym} 1530 270 0 1 {name=p50 sig_type=std_logic lab=en_bb}
C {vsource.sym} 850 430 0 0 {name=V6 value=1.6 savecurrent=false}
C {lab_wire.sym} 850 490 0 0 {name=p55 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 850 380 0 0 {name=p56 sig_type=std_logic lab=in}
C {sg13g2_stdcells/sg13g2_inv_1.sym} 1390 390 0 0 {name=x10 VDD=AVDD VSS=AVSS prefix=sg13g2_ }
C {lab_wire.sym} 1320 390 0 0 {name=p57 sig_type=std_logic lab=in}
C {lab_wire.sym} 1480 390 0 0 {name=p58 sig_type=std_logic lab=inb}
C {lab_wire.sym} 400 370 0 0 {name=p39 sig_type=std_logic lab=AVDD}
C {sg13g2_pr/sg13_lv_pmos.sym} 80 440 0 0 {name=M1
l=2u
w=2u
ng=1
m=2
...
C {sg13g2_pr/sg13_lv_pmos.sym} -30 440 0 1 {name=M2
l=2u
w=2u
ng=1
m=2
...
C {sg13g2_pr/sg13_lv_pmos.sym} 80 560 0 0 {name=M3
l=2u
w=2u
ng=1
m=2
...
C {sg13g2_pr/sg13_lv_pmos.sym} -30 560 0 1 {name=M4
l=2u
w=2u
ng=1
m=21
...
C {lab_wire.sym} 30 360 0 0 {name=p61 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} -80 440 0 0 {name=p62 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} -80 560 0 0 {name=p63 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} 120 560 0 1 {name=p64 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} 120 440 0 1 {name=p65 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} -50 750 0 0 {name=p37 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 100 620 0 0 {name=p38 sig_type=std_logic lab=IBIAS}
...
C {non_overlap.sym} -660 -40 0 0 {name=x6}
C {lab_wire.sym} -460 -50 0 1 {name=p10 sig_type=std_logic lab=sign}
C {lab_wire.sym} -460 -30 0 1 {name=p12 sig_type=std_logic lab=sign_b}
C {lab_wire.sym} -660 80 0 0 {name=p16 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} -660 -160 0 0 {name=p17 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} -840 -50 0 0 {name=p24 sig_type=std_logic lab=inb}
C {lab_wire.sym} -840 -70 0 0 {name=p25 sig_type=std_logic lab=in}
C {vsource.sym} 960 430 0 0 {name=V7 value=0 savecurrent=false}
C {lab_wire.sym} 960 490 0 0 {name=p26 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 960 380 0 0 {name=p27 sig_type=std_logic lab=a}
C {vsource.sym} 1050 430 0 0 {name=V13 value=1.6 savecurrent=false}
C {lab_wire.sym} 1050 490 0 0 {name=p30 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 1050 380 0 0 {name=p31 sig_type=std_logic lab=b}
C {lab_wire.sym} -840 -30 0 0 {name=p33 sig_type=std_logic lab=a}
C {lab_wire.sym} -840 -10 0 0 {name=p34 sig_type=std_logic lab=b}
...
C {vsource.sym} 630 430 0 0 {name=V4 value="PULSE(0 1.6 100u 1n 1n 1 2)" savecurrent=false}
C {res.sym} 490 360 2 0 {name=R7
value=0.1
footprint=1206
device=resistor
m=1}
...
C {lab_wire.sym} 280 -60 0 1 {name=p35 sig_type=std_logic lab=vop}
C {dsw.sym} 100 -50 0 0 {name=x7}
C {lab_wire.sym} 280 -40 0 1 {name=p36 sig_type=std_logic lab=vom}
C {lab_wire.sym} 100 50 0 0 {name=p47 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} -100 -50 0 0 {name=p68 sig_type=std_logic lab=sign}
C {lab_wire.sym} -100 -30 0 0 {name=p107 sig_type=std_logic lab=sign_b}
...
C {lab_wire.sym} -270 -90 0 0 {name=p110 sig_type=std_logic lab=ISUM}
C {vsource.sym} -220 -90 3 0 {name=V18 value=0 savecurrent=false}
