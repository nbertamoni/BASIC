...
N 700 -1000 750 -1000 {lab=en_b}
N 700 -970 750 -970 {lab=en_bb}
C {lab_wire.sym} 1190 -380 0 0 {name=p44 sig_type=std_logic lab=i_en}
...
C {lab_wire.sym} 790 -650 0 1 {name=p30 sig_type=std_logic lab=x_sign}
C {lab_wire.sym} 790 -630 0 1 {name=p31 sig_type=std_logic lab=x_signb}
...
C {lab_wire.sym} 1140 -650 0 0 {name=p109 sig_type=std_logic lab=x_sign}
C {lab_wire.sym} 1140 -630 0 0 {name=p110 sig_type=std_logic lab=x_signb}
...
C {lab_wire.sym} 540 -380 1 0 {name=p6 sig_type=std_logic lab=en_bb}
...
C {iopin.sym} 700 -1000 2 0 {name=p11 lab=en_b}
