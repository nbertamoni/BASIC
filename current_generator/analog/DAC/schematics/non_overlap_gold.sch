...
F {}
E {}
N 450 -250 600 -250 {lab=xb}
N 680 -250 750 -250 {lab=o_signb}
N 680 -470 750 -470 {lab=o_sign}
N 280 -490 330 -490 {lab=i_sign}
N 280 -450 330 -450 {lab=xb}
N 280 -270 330 -270 {lab=i_signb}
N 280 -230 330 -230 {lab=xa}
N 290 -860 340 -860 {lab=AVDD}
N 290 -830 340 -830 {lab=AVSS}
N 290 -800 340 -800 {lab=i_sign}
N 290 -770 340 -770 {lab=i_signb}
N 290 -740 340 -740 {lab=o_sign}
N 290 -710 340 -710 {lab=o_signb}
...
N 450 -470 600 -470 {lab=xa}
C {iopin.sym} 300 -860 0 1 {name=p85 lab=AVDD}
C {iopin.sym} 300 -830 0 1 {name=p86 lab=AVSS}
C {lab_wire.sym} 300 -450 0 0 {name=p1 sig_type=std_logic lab=xb}
...
C {lab_wire.sym} 730 -470 0 1 {name=p4 sig_type=std_logic lab=o_sign}
C {lab_wire.sym} 730 -250 0 1 {name=p5 sig_type=std_logic lab=o_signb}
C {iopin.sym} 300 -800 0 1 {name=p6 lab=i_sign}
C {iopin.sym} 300 -770 0 1 {name=p7 lab=i_signb}
C {iopin.sym} 300 -740 0 1 {name=p10 lab=o_sign}
C {iopin.sym} 300 -710 0 1 {name=p11 lab=o_signb}
...
C {lab_wire.sym} 300 -230 0 0 {name=p20 sig_type=std_logic lab=xa}
C {lab_wire.sym} 510 -470 0 0 {name=p21 sig_type=std_logic lab=xa}
C {lab_wire.sym} 530 -250 0 0 {name=p22 sig_type=std_logic lab=xb}
