...
F {}
E {}
N 370 -510 450 -510 {lab=VS_cm}
N 450 -510 450 -330 {lab=VS_cm}
N 450 -300 570 -300 {lab=AVDD}
N 450 -270 450 -180 {lab=ISUM}
N 330 -300 410 -300 {lab=VBIAS}
N 330 -300 330 -270 {lab=VBIAS}
N 330 -210 330 -170 {lab=AVDD}
N 220 -410 220 -370 {lab=AVSS}
N 220 -650 220 -610 {lab=AVDD}
...
C {sg13g2_stdcells/sg13g2_inv_1.sch} 290 -510 0 0 {}
C {lab_wire.sym} 450 -210 3 0 {name=p1 sig_type=std_logic lab=ISUM}
C {lab_wire.sym} 570 -300 2 0 {name=p2 sig_type=std_logic lab=AVDD}
C {sg13g2_pr/cap_cmim.sym} 330 -240 0 0 {name=C1
model=cap_cmim
w=7.0e-6
l=7.0e-6
m=1
...
C {lab_wire.sym} 330 -200 3 0 {name=p4 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} 390 -300 0 0 {name=p5 sig_type=std_logic lab=VBIAS}
C {lab_wire.sym} 390 -300 0 0 {name=p6 sig_type=std_logic lab=VBIAS}
C {lab_wire.sym} 220 -390 3 0 {name=p7 sig_type=std_logic lab=AVSS}
C {lab_wire.sym} 220 -630 1 0 {name=p8 sig_type=std_logic lab=AVDD}
